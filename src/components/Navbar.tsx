...
function Navbar() {
  return (
    <div className='flex flex-col max-w-[1640px] mx-auto max-h-[1200px] space-y-4 justify-center items-center'>
        <div className='flex space-x-8'>
        <p>Cat Care</p>
        <p>Feeding Locations</p>
        <p>Resources</p>
        </div>
        <img className="w-full object-cover max-h-[1000px]" src={catPhoto} alt='' />
